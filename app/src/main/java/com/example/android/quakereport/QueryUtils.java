...
public final class QueryUtils {
    ...
    /**
     * Consulte o conjunto de dados do USGS e devolva um objeto {@link ArrayList<Earthquake>} para representar um único terremoto.
*/
    public static ArrayList<Earthquake> buscarDadosTerremoto(String requisicaoUrl) {
        // Cria um objeto URL
        URL url = createUrl(requisicaoUrl);
    ...
    /**
     * Retornar um objeto {@link ArrayList<Earthquake>}, analisando informações sobre o primeiro terremoto da seqüência de dados EarthquakeJSON.
     */
